...
You can break down `TwpFastApp` code into several layers.
...
In `TwpFastApp`, we use [Abstract Base Class](https://docs.python.org/3/library/abc.html) as interface.
...
We have several layers in `TwpFastApp`

        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="form-input-session-id" class="col-form-label">SessionId:</label>
                        <input type="text" class="form-control" id="form-input-session-id" v-model="formData.session_id">
                    </div>
                    <div class="mb-3">
                        <label for="form-input-user-id" class="col-form-label">UserId:</label>
                        <input type="text" class="form-control" id="form-input-user-id" v-model="formData.user_id">
                    </div>
                    <!-- Put form input here -->
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            async _getRow(id) {
                ...
                throw new Error(appHelper.getResponseErrorMessage(response, `Cannot get view ${id}`));
            },
            ...
            async _insertRow(row) {
                ...
                throw new Error(appHelper.getResponseErrorMessage(response, `Cannot create view ${id}`));
            },
            ...
            async _updateRow(id, row) {
                ...
                throw new Error(appHelper.getResponseErrorMessage(response, `Cannot update view ${id}`));
            },
            ...
            async _deleteRow(id) {
                ...
                throw new Error(appHelper.getResponseErrorMessage(response, `Cannot delete view ${id}`));
            },
            ...
            async confirmDelete(id) {
                try {
                    const confirmation = await appHelper.confirm(`Are you sure to delete view ${id}?`);
                    if (!confirmation) {
                        return;
                    }
